        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-6  offset-lg-3 offset-md-3">
              <h2 class="module-title font-alt">Produk Terlaris Kami</h2>
              <div class="module-subtitle font-serif">Asap Cair Hama</div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
              <div class="alt-features-item">
                ...
                <h3 class="alt-features-title font-alt">Asap Cair untuk hama</h3>mempercepat proses penyembuhan luka maupun sariawan.
              </div>
              <div class="alt-features-item">
                <div class="alt-features-icon"><span class="icon-mobile"></span></div>
                <h3 class="alt-features-title font-alt">Asap Cair untuk hama</h3>mempercepat penyembuhan sariawan dengan meningkatkan pertumbuhan jaringan ikat atau kolagen..
              </div>
              <div class="alt-features-item">
                <div class="alt-features-icon"><span class="icon-linegraph"></span></div>
                <h3 class="alt-features-title font-alt">Asap Cair untuk hama</h3>mempercepat penyembuhan luka bakar.
              </div>
              <div class="alt-features-item">
                <div class="alt-features-icon"><span class="icon-basket"></span></div>
                <h3 class="alt-features-title font-alt">Asap Cair untuk hama</h3>mengandung senyawa aktif fenol dan asam yang bersifat antibakteri dan antioksidan.
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row mb-5 profile">
                ...
                <div class="col-12 col-sm-6 text-center pt-5 sejarah">
                    ...
                    <a style="color:white" href="{{route('profile',$item->id)}}">lihat selengkapnya....</a>
